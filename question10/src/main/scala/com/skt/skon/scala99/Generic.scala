...
import com.skt.skon.scala99.datastructure.EightQueens
...
object Generic {
  ...
  def problem = {
    ...
    // Example: List(4, 2, 7, 3, 6, 8, 5, 1) means that the queen in the first column is in row 4, the queen in the second column is in row 2, etc. Use the generate-and-test paradigm.
    val a90 = new EightQueens(8, 8)
    println("P90 : ")
    while (a90.hasNext)
      println(a90.next)
  }
